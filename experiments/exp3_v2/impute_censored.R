...
#' df is a dataframe with columns age, sex, kps, mgmt, isGTR, os, os_status
#' If method == "emin_tau", returns E(min{T, tau} | X, delta, Y)
#' If method is "median", return the median of the conditional distribution
#' P(T >= Y | Y, X, delta)
#' If method is "simulate", simulate from the above conditional distribution.
#' Returns a dataframe with original columns and one of event_time, emin_tau
