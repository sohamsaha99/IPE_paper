...
dir.create("results/example/v4/", recursive = TRUE, showWarnings = FALSE)
write.csv(results, "results/example/v4/results.csv", row.names = FALSE)
results <- read.csv("results/example/v4/results.csv", header = TRUE)
# Visualize results
...
ggsave("results/example/C.svg", plot = p3,
       width = 15, height = 5, units = "in")
ggsave("results/example/D.svg", plot = p4,
       width = 15, height = 5, units = "in")
ggsave("results/example/E.svg", plot = p5,
       width = 15, height = 5, units = "in")
